...
SC queryex "%ServiceName%"|Find "does not exist">Nul&&(
        ...
        xcopy "%SplunkHome%\etc\apps\TA-telegraf-windows-64\local\telegraf.conf" "%SplunkHome%\var\run\telegraf\" /K /D /H /Y
        xcopy "%SplunkHome%\etc\apps\TA-telegraf-windows-64\bin\telegraf\telegraf.exe" "%SplunkHome%\var\run\telegraf\" /K /D /H /Y
